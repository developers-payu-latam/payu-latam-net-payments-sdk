// <copyright file="GetRecurringBillItemStrategy.cs" company="PayU Latam">
...
namespace PayuNetSdk.PayU.RequestStrategies.RecurringBillItems
{
    ...
    /// 
    /// </summary>
    internal class GetRecurringBillItemStrategy :
        AbstractRestRequestStrategy<RecurringBillItemRequest, RecurringBillItem, SdkError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRecurringBillItemStrategy "/> class.
        /// </summary>
        /// <param name="request">The request.</param>
        public GetRecurringBillItemStrategy(RecurringBillItemRequest request)
            : base(request)
        {
        ...
        {
            return new RestRequest("recurringBillItems/{id}", Method.GET);
        }
