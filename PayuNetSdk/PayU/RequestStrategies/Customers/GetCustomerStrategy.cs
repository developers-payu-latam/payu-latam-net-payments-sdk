// <copyright file="GetCustomerStrategy.cs" company="PayU Latam">
...
namespace PayuNetSdk.PayU.RequestStrategies.Customers
{
    ...
    /// 
    /// </summary>
    internal class GetCustomerStrategy :
        AbstractRestRequestStrategy<CustomerRequest, Customer, SdkError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomerStrategy "/> class.
        /// </summary>
        /// <param name="request">The request.</param>
        public GetCustomerStrategy(CustomerRequest request)
            : base(request)
        {
        ...
        {
            return new RestRequest("customers/{id}", Method.GET);
        }
