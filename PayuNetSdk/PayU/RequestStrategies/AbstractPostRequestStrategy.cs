...
namespace PayuNetSdk.PayU.RequestStrategies
{
    ...
    internal abstract class AbstractPostRequestStrategy<T, V>
        where T : AbstractRequest where V : new()
    {

        private IRestRequest restRequest;
        private IRestResponse<V> restResponse;
        ...
        /// The rest response.
        /// </value>
        public IRestResponse<V> RestResponse
        {
        ...
        public abstract IRestResponse<V> CreateResponse();
        ...
        {
            restResponse = restClient.Execute<V>(restRequest);
        }
