// <copyright file="DeleteSubscriptionPlanStrategy.cs" company="PayU Latam">
...
namespace PayuNetSdk.PayU.RequestStrategies.Plans
{
    ...
    /// 
    /// </summary>
    internal class DeleteSubscriptionPlanStrategy :
        AbstractRestRequestStrategy<SubscriptionPlanRequest, SubscriptionPlan, SdkError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSubscriptionPlanStrategy"/> class.
        /// </summary>
        /// <param name="request">The request.</param>
        public DeleteSubscriptionPlanStrategy(SubscriptionPlanRequest request)
            : base(request)
        {
        ...
        {
            return new RestRequest("plans/{planCode}", Method.DELETE);
        }
