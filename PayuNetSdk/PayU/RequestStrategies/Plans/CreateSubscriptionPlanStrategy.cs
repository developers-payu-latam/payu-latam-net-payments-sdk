// <copyright file="CreateSubscriptionPlanStrategy.cs" company="PayU Latam">
...
namespace PayuNetSdk.PayU.RequestStrategies.Plans
{
    ...
    /// 
    /// </summary>
    internal class CreateSubscriptionPlanStrategy :
        AbstractRestRequestStrategy<SubscriptionPlanRequest, SubscriptionPlan, SdkError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionPlanStrategy"/> class.
        /// </summary>
        /// <param name="request">The request.</param>
        public CreateSubscriptionPlanStrategy(SubscriptionPlanRequest request)
            : base(request)
        {
        ...
        {
            return new RestRequest("plans", Method.POST);
        }
