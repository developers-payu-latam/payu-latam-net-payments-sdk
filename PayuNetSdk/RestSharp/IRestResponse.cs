...
namespace RestSharp
{
    ...
    /// </summary>
    /// <typeparam name="T">Type of data to deserialize to</typeparam>
    /// <typeparam name="E">Type of data error to deserialize to</typeparam>
    public interface IRestResponse<T, E> : IRestResponse
    {
        /// <summary>
        /// Deserialized entity data
        /// </summary>
    ...
    /// <typeparam name="T">Type of data to deserialize to</typeparam>
    /// <typeparam name="E">Type of data error to deserialize to</typeparam>
    /// <typeparam name="C">Type of data extra to deserialize to</typeparam>
    public interface IRestResponse<T, E, C> : IRestResponse<T, E>
    {
        /// <summary>
