...
namespace RestSharp
{
	public partial class RestClient
	{
        ...
        /// </summary>
        /// <typeparam name="T">Target deserialization type</typeparam>
        /// <typeparam name="E">Target error deserialization type</typeparam>
        /// <param name="request">Request to execute</param>
        /// <returns>
        /// RestResponse[[T]] with deserialized data in Data property
        /// </returns>
        public virtual IRestResponse<T, E> Execute<T, E>(IRestRequest request)
            where T : new()
            where E : new()
        {
            return Deserialize<T, E>(request, Execute(request));
        }
        ...
        /// RestResponse[[T]] with deserialized data in Data property
        /// </returns>
        public virtual IRestResponse<T, E, C> Execute<T, E, C>(IRestRequest request)
            where T : new()
            where E : new()
            where C : new()
        {
            return Deserialize<T, E, C>(request, Execute(request));
        }
	}
}
#endif