...
namespace RestSharp
{
    ...
    /// </summary>
    /// <typeparam name="T">Type of data to deserialize to</typeparam>
    public class RestResponse<T, E> : RestResponseBase, IRestResponse<T, E>
    {
        /// <summary>
        /// Deserialized entity data
        /// </summary>
        ...
        public static explicit operator RestResponse<T, E>(RestResponse response)
        {
    ...
    public class RestResponse<T, E, C> : RestResponseBase, IRestResponse<T, E, C>
    {
        /// <summary>
        /// Deserialized entity data
        /// </summary>
        ...
        public C ExtraData { get; set; }

        public static explicit operator RestResponse<T, E, C>(RestResponse response)
        {
